...
| [NXOSfirstboot.yml](https://github.com/NetworkNick-US/Operations/blob/main/nxosFirstBoot.yml) | Configures security requirements, features, and interfaces for newly acquired Cisco Nexus devices. | - |
